...
const Childhood = () => {
  return (
    <div class="Allsection-properti"  style={{paddingTop:"100px"}}   >
    <div id="Glassmorfism">
      <h1 id="prop">Journey</h1>
    <div id="dummy">  <p>Sumer Singh Adhana, a real estate consultant at Provident Estate in Dubai, embodies resilience, dedication, and success in the competitive real estate market. Born into a family with a military tradition in Jaipur, India, Sumer's upbringing instilled values ​​of discipline and determination.
...
<br></br>
Aligned with Provident Estate's vision, Sumer aims to make a global impact in the real estate industry. His journey inspires aspiring professionals, showing the power of resilience and determination in achieving success</p></div>
   </div></div>
  )
}
